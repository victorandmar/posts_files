...
fig1 = go.Figure()
fig1.add_trace(go.Scatter(x=x,y=sus_rj_dt1sin['2020-03':].rolling(14).mean(),
                    mode='lines',
                    name='Data do 1º sintoma'))

fig1.add_trace(go.Scatter(x=x, y=sus_rj_dtnotif['2020-03':].rolling(14).mean(),
                    mode='lines',
                    name='Data de notificação'))

fig1.add_trace(go.Scatter(x=x, y=sus_rj_dtobito['2020-03':].rolling(14).mean(),
                    mode='lines',
...
fig2 = go.Figure()
fig2.add_trace(go.Scatter(x=x,y=sus_rj_dt1sin['2020-03':].cumsum(),
                    mode='lines',
                    name='Data do 1º sintoma'))

fig2.add_trace(go.Scatter(x=x, y=sus_rj_dtnotif['2020-03':].cumsum(),
                    mode='lines',
                    name='Data de notificação'))

fig2.add_trace(go.Scatter(x=x, y=sus_rj_dtobito['2020-03':].cumsum(),
                    mode='lines',
                    name='Data de ocorrência do óbito'))
